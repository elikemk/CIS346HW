...
#Elikem Kalitsi November 5th 2023
import tkinter
...
class TestAvg:
    def __init__(self):
        ...
        self.grade_label = tkinter.Label(self.grade_frame, textvariable=self.grade)
    ...
    def calculate(self):
        ...
        if self.average >= 90:
            self.grade.set('Grade: A')
        elif self.average >= 80:
            self.grade.set('B')
        elif self.average >= 70:
            self.grade.set('Grade: C')
        elif self.average >= 60:
            self.grade.set('Grade: D')
        else:
            self.grade.set('Grade: F')
